...
plot_frq(bns$q77, geom.colors = plot_color) + xlab('Daily Fruit & Vegetable Servings') + ylab("Number of Students") + ylim(0, 1.3*max(table(bns$q77)))
...
plot_frq(bns$q78, geom.colors = plot_color, drop.empty = FALSE) + xlab('Daily Sugar-Sweetened Beverage Intake (Ounces)') + ylab("Number of Students") + ylim(0, 1.3*max(table(bns$q78)))
...
plot_frq(bns$q79, geom.colors = plot_color, drop.empty = FALSE) + xlab('Weekly Fast Food Intake') + ylab("Number of Students") + ylim(0, 1.3*max(table(bns$q79)))
```
...
plot_frq(bns$q80, geom.colors = plot_color) + xlab('Weekly Alcohol Intake') + ylab("Number of Students") + ylim(0, 1.3*max(table(bns$q80)))
...
plot_frq(bns$q81, geom.colors = plot_color) + xlab('Alcohol Servings Consumed When Drinking') + ylab("Number of Students") + ylim(0, 1.3*max(table(bns$q81)))
