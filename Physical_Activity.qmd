...
**Additional Notes:** For each exercise type, students had the options to select anywhere from zero days per week to seven days per week. In the table, percentages are calculated across rows. 
